...
contract AssetToken is ERC20 {
    ...
    // ans its the rate between the underlying and asset token
    ...
    constructor(
        address thunderLoan,
        IERC20 underlying, // e the token being deposited for flash loan
        // oh, are the ERC20s stored in AssetToken.sol instead of ThunderLLoan?
        // q where are the tokens stored?
        // ans they are stored in the assetToken contract
    ...
    function transferUnderlyingTo(address to, uint256 amount) external onlyThunderLoan {
        ...
        // if a user is denylisted, and it effects ethers, this is bad
        i_underlying.safeTransfer(to, amount);
    }

    // e responsile for updating the exchange rate of AssetTokens -> Underlying
    function updateExchangeRate(uint256 fee) external onlyThunderLoan {
        ...
        // @audit gas - too many storage reads -> stores as a memory variable
